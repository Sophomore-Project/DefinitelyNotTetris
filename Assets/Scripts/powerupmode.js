...
let tetrominoColors = ['purple', 'cyan', 'blue', 'yellow', 'orange', 'green' , 'red','pink','black','brown','lime'];//pink,blacks,brown, and lime are special
...
function Track1() {
    let myMusic;
      myMusic = new Audio("/DefinitelyNotTetris/Assets/Music/tetris-gameboy-01.mp3");
      myMusic.play();
      setTimeout(Track2,39000); 
    }
    function Track2() {
        let myMusic;
          myMusic = new Audio("/DefinitelyNotTetris/Assets/Music/tetris-gameboy-05.mp3");
          myMusic.play();
          setTimeout(Track1,57000); 
        }
...
function CreateTetrominos(){
    ...
    tetrominos.push([[0,0]]);
    tetrominos.push([[0,0]]);//these guys are the special tetrominoes
    tetrominos.push([[0,0]]);
    tetrominos.push([[0,0]]);
}
...
let ReturnIndex;
    ...
    TetrominoIndex = Math.floor(Math.random()*100);//100 can be lowered to decreased chances or raised to increase chances of special tetromino
    if(TetrominoIndex < 13){
        ReturnIndex = 0;
    }else if(13<=TetrominoIndex&&TetrominoIndex<26){
        ReturnIndex = 1;
    }else if(26<=TetrominoIndex&&TetrominoIndex<39){
        ReturnIndex = 2;
    }else if(39<=TetrominoIndex&&TetrominoIndex<52){
        ReturnIndex = 3;
    }else if(52<=TetrominoIndex&&TetrominoIndex<65){
        ReturnIndex = 4;
    }else if(65<=TetrominoIndex&&TetrominoIndex<78){
        ReturnIndex = 5;
    }else if(78<=TetrominoIndex&&TetrominoIndex<91){
        ReturnIndex = 6;
    }else if(91<=TetrominoIndex){
        ReturnIndex = 7;
    }
    if(ReturnIndex == 7){
        ReturnIndex = PowerUpDecider();
    }
    return ReturnIndex;
}
